  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
          <h1 className="text-2xl font-bold text-stone-900">{t('adminTeams')}</h1>
          <p className="text-stone-500">{t('adminTeamsSubtitle')}</p>
        </div>
      ...
      {teams.length === 0 ? (
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <h3 className="text-lg font-medium text-stone-900 mb-2">{t('adminNoTeams')}</h3>
            <p className="text-stone-500 mb-6">{t('adminNoTeamsMessage')}</p>
            <Link href="/app/teams/new">
