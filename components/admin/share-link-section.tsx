        ...
        <CardContent>
          ...
          <div className="mt-5 pt-4 border-t border-gray-100">
            <button
              ...
              className="-ml-2 flex items-center gap-2 px-2 py-2 min-h-11 text-sm text-gray-500 hover:text-gray-700 hover:bg-gray-100 active:bg-gray-200 rounded-lg transition-colors"
            >
              <svg
            ...
            {showAdvanced && (
              <div className="mt-4 space-y-4 animate-fade-in">
                ...
                <button
                  ...
                  className="-ml-2 flex items-center gap-2 px-3 py-2 min-h-11 text-sm text-gray-500 hover:text-red-600 hover:bg-red-50 active:bg-red-100 rounded-lg transition-colors group"
                >
