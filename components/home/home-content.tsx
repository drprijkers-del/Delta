    ...
    <div className="min-h-screen flex flex-col bg-stone-900 text-white">
      ...
      <header className="p-6 flex justify-between items-center">
        <div className="flex items-center gap-2">
          <span className="text-2xl font-bold text-cyan-400">Δ</span>
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6">
        <div className="text-center max-w-2xl">
          {/* Logo */}
          <div className="text-8xl font-bold text-cyan-400 mb-8">Δ</div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-12 max-w-lg mx-auto">
            <div className="bg-stone-800 rounded-xl p-4">
              ...
              <div className="text-xs text-stone-400">One focus area</div>
            </div>
            <div className="bg-stone-800 rounded-xl p-4">
              <div className="text-2xl mb-2">🧪</div>
              <div className="text-xs text-stone-400">One experiment</div>
            </div>
            <div className="bg-stone-800 rounded-xl p-4">
              <div className="text-2xl mb-2">👤</div>
              <div className="text-xs text-stone-400">One owner</div>
            </div>
            <div className="bg-stone-800 rounded-xl p-4">
              <div className="text-2xl mb-2">📅</div>
              <div className="text-xs text-stone-400">One follow-up</div>
            </div>
          </div>

          {/* Login Flow */}
          {emailSent ? (
            <div className="bg-stone-800 rounded-2xl p-6 max-w-sm mx-auto mb-6">
            ...
            <form onSubmit={handleSubmit} className="max-w-sm mx-auto mb-6">
              <div className="flex gap-2">
                <input
                  ...
                  required
                  autoFocus
                  className="flex-1 px-4 py-3 rounded-xl bg-stone-800 border border-stone-700 text-white placeholder:text-stone-500 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-transparent"
                />
                <button
                  type="submit"
                  disabled={loading || !email}
                  className="px-6 py-3 bg-cyan-500 text-stone-900 rounded-xl hover:bg-cyan-400 transition-colors disabled:opacity-50 font-semibold"
                >
                  {loading ? '...' : '→'}
                </button>
              </div>
              ...
              <button
                ...
                className="text-xs text-stone-500 hover:text-white mt-2"
              >
                ← Back
              </button>
            </form>
            ...
            <div className="space-y-4 mb-6">
              <button
                ...
                className="px-8 py-4 bg-cyan-500 text-stone-900 rounded-xl hover:bg-cyan-400 transition-colors font-semibold"
              >
